            ...
            <div class="profile__wrapper">
                ...
                <div class="profile__info">
                    ...
                    <div class="profile__actions">
                        <a href="#" @click="$emit('openModal', $event)" class="button button--primary feedback-button" v-if="$store.state.userRoles.includes('teacher')">
                            <p>Geef feedback</p>
                        ...
                        <a href="#" class="button button--secondary profile-options-button" v-if="$store.state.userRoles.includes('teacher')">
                            <svg class="button__only-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 72 18" style="overflow:visible;enable-background:new 0 0 72 18;" xml:space="preserve"><circle cx="9" cy="9" r="9"/><circle cx="36" cy="9" r="9"/><circle cx="63" cy="9" r="9"/></svg>
                        </a>
                    </div>
                </div>
            </div>
