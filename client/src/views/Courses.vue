    ...
    <div class="page page--padding">
        ...
        <div v-if="!loading">
                ...
                <a @click="toggleModalTraject" class="trajecten__add col-1" href="#">
                    <div class="trajecten__icon">
                        <svg
                            ...
                            y="0px"
                            viewBox="0 0 99 99"
                            style="overflow:visible;enable-background:new 0 0 99 99;"
                            xml:space="preserve"
                        >
                            <path
                                d="M99,49.5c0,1.2-0.5,2.4-1.3,3.2c-0.8,0.8-1.9,1.3-3.2,1.3H54v40.5c0,2.5-2,4.5-4.5,4.5S45,97,45,94.5V54H4.5 C2,54,0,52,0,49.5S2,45,4.5,45H45V4.5C45,2,47,0,49.5,0c1.2,0,2.4,0.5,3.2,1.3C53.5,2.1,54,3.3,54,4.5V45h40.5C97,45,99,47,99,49.5z"
                            />
                        </svg>
                    </div>
                </a>
            ...
            <transition name="fade-fast" mode="out-in">
                <Modal
                    @closeModal="toggleModalTraject"
                    v-if="showTrajectModal"
                    :modalTitle="'Traject toevoegen'"
                >
                    <p>test</p>
                </Modal>
            </transition>
